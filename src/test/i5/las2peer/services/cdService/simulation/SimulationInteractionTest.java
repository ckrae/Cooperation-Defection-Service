...
/**
 * It is hard to determine the exact simulation process because of the
...
public class SimulationInteractionTest {
	...
	public void ImitationPrisonersDilemmaDefection() {
		...
		SimulationDataset simulationDataset = simulation.getSimulationData();
		assertNotNull(simulationDataset);
